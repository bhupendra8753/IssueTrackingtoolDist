(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppService = /** @class */ (function () {
                ...
                //------------------------ dashboard ----------------------------------
                AppService.prototype.getAllIssues = function (userId) {
                ...
                AppService.prototype.getIssueById = function (issueId) {
                ...
                AppService.prototype.createNewIssue = function (data) {
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('authToken', ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authToken'))
                ...
                AppService.prototype.addNewComment = function (issueId, data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardViewComponent = /** @class */ (function () {
                function DashboardViewComponent(appService, socketService, router, toastr) {
                    var _this = this;
                    ...
                    this.getAllIssues = function () {
                        _this.appService.getAllIssues(_this.userInfo.userId).subscribe(function (data) {
                            if (data.status == 200) {
                                _this.allIssues = data['data'];
                    ...
                    this.verifyUserAndJoinIssues = function () {
                    ...
                    this.joinChatRoom = function () {
                        var roomData = {
                            roomId: _this.userInfo.userId,
                            userId: _this.userInfo.userId,
                            userName: _this.userName
                        };
                        _this.socketService.startRoom().subscribe(function (data) {
                            _this.socketService.emitJoinRoom(roomData);
                        });
                    };
                    // navigate to next view to create new issue
                    this.createNewIssue = function () {
                        _this.router.navigate(['/description']);
                    };
                    // navigate to issue-description view
                    this.selectedIssue = function (issueId) {
                        _this.router.navigate(['/description', issueId]);
                    };
                    this.logout = function () {
                        _this.appService.logout()
                            ...
                            if (apiResponse.status === 200) {
                                ...
                                _this.socketService.disconnect(_this.userInfo.userId);
                                _this.router.navigate(['/']); //navigating to signin page
                            }
                            else {
                ...
                DashboardViewComponent.prototype.ngOnInit = function () {
                    ...
                    this.socketService.updateIssueList().subscribe(function (data) {
                        _this.getAllIssues();
                        _this.toastr.info("A new issue " + data.newIssueTitle + " has been assigned to you by " + data.newReporterName, 'New notification');
                    });
                    this.socketService.receiveNotification().subscribe(function (data) {
                        if (data.editedContent == 'comment') {
                            _this.issueEdited = false;
                            _this.notifCounter++;
                            if (Array.isArray(_this.notifData)) {
                                _this.notifData.push(data);
                            }
                            else {
                                _this.notifData = [];
                                _this.notifData.push(data);
                            }
                            _this.toastr.success("Open notifications panel for details", 'New Notification');
                        }
                        else {
                            _this.issueEdited = true;
                            _this.notifCounter++;
                            if (Array.isArray(_this.notifData)) {
                                _this.notifData.push(data);
                            }
                ...
                DashboardViewComponent.prototype.sortIssues = function (property) {
                    this.sortType = property;
                    this.sortDesc = !this.sortDesc;
                    this.allIssues.sort(this.dynamicSort(property));
                };
                DashboardViewComponent.prototype.dynamicSort = function (property) {
                    // default: minus(-)1 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IssueDescriptionViewComponent = /** @class */ (function () {
                function IssueDescriptionViewComponent(location, appService, socketService, router, toastr, activatedRoute, locale) {
                    var _this = this;
                    ...
                    this.getallUsers = function () {
                        _this.appService.getAllUsers().subscribe(function (data) {
                            if (data.status === 200) {
                    ...
                    this.getSelectedIssue = function () {
                        _this.appService.getIssueById(_this.issueId).subscribe(function (data) {
                            // console.log(data)
                            if (data.status === 200) {
                                ...
                                _this.tempIssueData = Object.assign({}, data.data);
                                ...
                                _this.tempIssueData.assignee = data.data.assigneeId;
                                // format date to short date
                                _this.currentIssue.createdOn = Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(_this.currentIssue.createdOn, 'yyyy-MMMM-dd', _this.locale);
                                _this.commentsList = data.data.comments.reverse();
                    ...
                    this.getSelectedIssueFollowers = function () {
                        _this.socketService.emitGetFollowersList(_this.issueId);
                        _this.socketService.getFollowersList(_this.issueId).subscribe(function (data) {
                            // console.log("inside getFollowersList: " + JSON.stringify(data))
                            for (var key in data) {
                                // console.log("followers list key:" + key)
                                if (key === _this.userInfo.userId) {
                                    _this.isChecked = true;
                                }
                                _this.followersList.push({ followerName: data[key] });
                            }
                    ...
                    this.createNewIssue = function () {
                        var createAndFollow = function () {
                            return new Promise(function (resolve, reject) {
                                var assigneeName;
                                for (var _i = 0, _a = _this.allUsers; _i < _a.length; _i++) {
                                    var user = _a[_i];
                                    if (user.userId === _this.assigneeText) {
                                        assigneeName = user.firstName + ' ' + user.lastName;
                                    }
                                }
                                var newIssueData = {
                                    title: _this.titleText,
                                    description: _this.descriptionText,
                                    reporter: _this.userName,
                                    reporterId: _this.userInfo.userId,
                                    assignee: assigneeName,
                                    assigneeId: _this.assigneeText,
                                    status: _this.statusText,
                                    createdOn: Date.now
                                };
                                // console.log("New Issue data:" + JSON.stringify(newIssueData))
                                _this.appService.createNewIssue(newIssueData).subscribe(function (data) {
                                    if (data.status === 200) {
                                        _this.toastr.success("New Issue created sucessfully!");
                                        // when a new issue is created, 2 followers will always be there i.e:
                                        // reporter & assignee
                                        var reporterFollowerData = {
                                            issueId: data.data.issueId,
                                            userId: data.data.reporterId,
                                            userName: data.data.reporter,
                                            issueTitle: data.data.title
                                        };
                                        var assigneeFollowerData = {
                                            issueId: data.data.issueId,
                                            userId: data.data.assigneeId,
                                            userName: data.data.assignee,
                                            issueTitle: data.data.title
                                        };
                                        _this.socketService.followIssue(reporterFollowerData);
                                        _this.socketService.followIssue(assigneeFollowerData);
                                        resolve(data);
                                    }
                                    else {
                        ...
                        var sendNotif = function (data) {
                            return new Promise(function (resolve, reject) {
                                ...
                                _this.socketService.notifyNewAssigneeOfNewIssue(notifData);
                    ...
                    this.editIssue = function (form) {
                        // ----- custom logic to track form field changes and specify which field changed --------
                        _this.hasChanges = false;
                        var whatChanged = [];
                        for (var prop in form) {
                            if (prop !== 'follow' && prop !== 'assignee') {
                                if (_this.tempIssueData[prop] !== form[prop]) {
                                    _this.hasChanges = true;
                                    whatChanged.push(prop);
                                    _this.tempIssueData[prop] = form[prop];
                                }
                            }
                            if (prop === 'assignee' && _this.tempIssueData['assignee'] !== form['assignee']) {
                                _this.hasChanges = true;
                                whatChanged.push('assignee');
                                _this.tempIssueData['assignee'] = form['assignee'];
                                console.log("New assignee: " + _this.currentIssue.assigneeId + form['assignee']);
                                var followData = {
                                    issueId: _this.issueId,
                                    userId: form['assignee'],
                                    userName: _this.userName
                                };
                                _this.socketService.followIssue(followData);
                                var notifData = {
                                    assigneeId: form['assignee'],
                                    issueId: _this.issueId,
                                    newIssueTitle: form['title'],
                                    newReporterName: _this.userName,
                                    editedContent: 'new issue'
                                };
                                _this.socketService.notifyNewAssigneeOfNewIssue(notifData);
                            }
                        }
                        if (_this.hasChanges === true) {
                            _this.appService.editIssue(_this.issueId, _this.currentIssue).subscribe(function (data) {
                                if (data.status === 200) {
                                    _this.toastr.success("Edited successfully");
                                    console.log("whatchanged: " + whatChanged);
                                    var notifData = {
                                        editedBy: _this.userName,
                                        editedContent: whatChanged,
                                        issueTitle: _this.currentIssue.title,
                                        issueId: _this.issueId
                                    };
                                    _this.socketService.notifyFollowers(notifData);
                            ...
                            _this.toastr.error("No chnages made!");
                        }
                    };
                    // click event - to add a new comment to an issue
                    this.addNewComment = function () {
                        if (_this.comments === null || _this.comments === '' || _this.comments.length === 0) {
                            _this.toastr.error("Comment can't be blank!");
                        }
                        else {
                            var commentData = {
                                commenterId: _this.userInfo.userId,
                                commenterName: _this.userName,
                                commentText: _this.comments
                            };
                            _this.appService.addNewComment(_this.issueId, commentData).subscribe(function (data) {
                                if (data.status === 200) {
                ...
                IssueDescriptionViewComponent.prototype.followCheckBox = function (event) {
                    if (event === 'Y') {
            ...
            IssueDescriptionViewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IssueTrackerModule = /** @class */ (function () {
                function IssueTrackerModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SocketService = /** @class */ (function () {
                function SocketService(http) {
                    ...
                    this.followIssue = function (followerData) {
                        _this.socket.emit('follow-issue', followerData);
                    };
                    this.unFollowIssue = function (unFollowerData) {
                        _this.socket.emit('unfollow-issue', unFollowerData);
                    };
                    this.emitGetFollowersList = function (issueId) {
                        _this.socket.emit('get-all-followers', issueId);
                    };
                    this.notifyFollowers = function (data) {
                        console.log("Inside notify emit");
                        _this.socket.emit('notify-all-followers', data);
                    };
                    this.startRoom = function () {
                        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
                            _this.socket.on('startUserRoom', function (data) {
                                observer.next(data);
                            });
                        });
                    };
                    this.emitJoinRoom = function (data) {
                        _this.socket.emit('joinUserRoom', data);
                    };
                    this.notifyNewAssigneeOfNewIssue = function (data) {
                        _this.socket.emit('notify-assignee-new-issue', data);
                    };
                    this.updateIssueList = function () {
                        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
                            _this.socket.on('update-issue-list', function (data) {
                                observer.next(data);
                            });
                        });
                    };
                    this.disconnect = function (userId) {
                        _this.socket.disconnect(userId);
                    };
                ...
                SocketService.prototype.getFollowersList = function (issueId) {
                    var _this = this;
                    return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
                        _this.socket.on(issueId, function (data) {
                            observer.next(data);
                        });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(appService, router, toastr, location) {
                    var _this = this;
                    this.appService = appService;
                    this.router = router;
                    this.toastr = toastr;
